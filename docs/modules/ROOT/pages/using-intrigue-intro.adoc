...
[NOTE]
====
For more detail on any feature or button within {catalog-ui}, click the `?` icon in the upper right of the screen; then, hover over any item on the screen and a contextual tooltip is displayed to define its purpose.
