 ...
 * Guidelines</a>.
 */
public class UiAttributeImpl implements Attribute {
   ...
   */
  public UiAttributeImpl(String name, Serializable value) {
    /*
   ...
   * See {@link #UiAttributeImpl(String, Serializable)}.
   */
  public static UiAttributeImpl fromSingleValue(String name, Serializable value) {
    return new UiAttributeImpl(name, value);
  }
   ...
   */
  public UiAttributeImpl(String name, List<? extends Serializable> values) {
    /*
     * If any defensive logic is added to this constructor, then that logic should be reflected
     * in the deserialization (readObject()) of this object so that the integrity of a
     * serialized object is maintained. For instance, if a null check is added in the
  ...
  /** Copy Constructor */
  public UiAttributeImpl(Attribute attribute) {
    /*
     * If any defensive logic is added to this constructor, then that logic should be reflected
     * in the deserialization (readObject()) of this object so that the integrity of a
     * serialized object is maintained. For instance, if a null check is added in the
  ...
  /**
   * Serializes this {@link UiAttributeImpl} instance.
   *
  ...
  /**
   * Deserializes this {@link UiAttributeImpl}'s instance.
   *
