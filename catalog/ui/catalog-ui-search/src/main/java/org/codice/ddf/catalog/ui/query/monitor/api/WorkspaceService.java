...
public interface WorkspaceService {
     ...
     */
    default Map<WorkspaceMetacardImpl, List<QueryMetacardImpl>> getQueryMetacards() {
        Map<WorkspaceMetacardImpl, List<QueryMetacardImpl>> queryMetacards = new HashMap<>();
        for (WorkspaceMetacardImpl workspaceMetacard : getWorkspaceMetacards()) {
            queryMetacards.put(workspaceMetacard, getQueryMetacards(workspaceMetacard));
        }
    ...
    default WorkspaceMetacardImpl getWorkspaceMetacard(String workspaceId) {
