...
var AttributeComponent = function (_a) {
    ...
    var _d = useMetacardDefinitions(), getAlias = _d.getAlias, getType = _d.getType;
    var label = getAlias(attr);
...
var Summary = function (_a) {
    ...
    var _h = useMetacardDefinitions(), isHiddenTypeExceptThumbnail = _h.isHiddenTypeExceptThumbnail, getMetacardDefinition = _h.getMetacardDefinition;
