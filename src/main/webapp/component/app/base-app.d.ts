...
export declare const CommonRouteContainer: ({ children, className, suspenseProps, }: {
    children: React.ReactNode;
    className?: string;
    suspenseProps?: SuspenseProps;
}) => import("react/jsx-runtime").JSX.Element;
export declare const ComplexRouteContainer: ({ children, suspenseProps, }: {
    children: React.ReactNode;
    suspenseProps?: SuspenseProps;
}) => import("react/jsx-runtime").JSX.Element;
/**
...
declare const WrappedWithProviders: () => import("react/jsx-runtime").JSX.Element;
