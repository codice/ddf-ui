...
function getAllValidValuesForMatchTypeAttribute() {
    ...
    return metacardDefinitions.enums[matchTypeAttr]
        ? metacardDefinitions.enums[matchTypeAttr].reduce(function (blob, value) {
            blob[value] = {
                label: value,
                value: value,
...
function isTypeLimiter(filter) {
    ...
    var metadataContentTypeSupported = Boolean(metacardDefinitions.metacardTypes[METADATA_CONTENT_TYPE]);
            ...
            React.createElement("div", { className: "pt-2" },
                ...
                basicFilter.anyType.on ? (React.createElement(Grid, { container: true, alignItems: "stretch", direction: "row", wrap: "nowrap", className: "pt-2" },
                    React.createElement(Grid, { item: true },
                        React.createElement(Swath, { className: "w-1 h-full" })),
                    React.createElement(Grid, { item: true, className: "w-full pl-2" },
                        React.createElement(Autocomplete, { fullWidth: true, multiple: true, options: Object.values(typeAttributes), disableCloseOnSelect: true, getOptionLabel: function (option) { return option.label; }, getOptionSelected: function (option, value) {
                                return option.value === value.value;
                            }, onChange: function (_e, newValue) {
                                basicFilter.anyType.properties = newValue.map(function (val) { return val.value; });
                                model.set('filterTree', constructFilterFromBasicFilter({ basicFilter: basicFilter }));
                            }, size: "small", renderOption: function (_a) {
