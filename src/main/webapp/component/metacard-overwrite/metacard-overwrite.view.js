...
var OverwriteConfirm = styled(Button)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  display: inline-block;\n  white-space: normal;\n  vertical-align: top !important;\n  width: 100%;\n  transform: translateX(0%);\n  transition: transform ", " linear;\n  height: auto;\n"], ["\n  display: inline-block;\n  white-space: normal;\n  vertical-align: top !important;\n  width: 100%;\n  transform: translateX(0%);\n  transition: transform ", " linear;\n  height: auto;\n"])), function (props) { return props.theme.coreTransitionTime; });
var MainText = styled.span(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: block;\n  font-size: ", ";\n"], ["\n  display: block;\n  font-size: ", ";\n"])), function (props) { return props.theme.largeFontSize; });
var SubText = styled.span(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  display: block;\n  font-size: ", ";\n"], ["\n  display: block;\n  font-size: ", ";\n"])), function (props) { return props.theme.mediumFontSize; });
var OverwriteStatus = styled.div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  display: inline-block;\n  white-space: normal;\n  vertical-align: top !important;\n  width: 100%;\n  transform: translateX(0%);\n  transition: transform ", " linear;\n  text-align: center;\n  position: relative;\n  padding: 10px;\n"], ["\n  display: inline-block;\n  white-space: normal;\n  vertical-align: top !important;\n  width: 100%;\n  transform: translateX(0%);\n  transition: transform ", " linear;\n  text-align: center;\n  position: relative;\n  padding: 10px;\n"])), function (props) { return props.theme.coreTransitionTime; });
var OverwriteProgress = styled(OverwriteStatus)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  line-height: ", ";\n"], ["\n  line-height: ", ";\n"])), function (props) { return props.theme.minimumButtonSize; });
var ProgressText = styled.div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  padding: 10px;\n  top: 0px;\n  left: 0px;\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  z-index: 1;\n  font-size: ", ";\n  color: ", ";\n"], ["\n  padding: 10px;\n  top: 0px;\n  left: 0px;\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  z-index: 1;\n  font-size: ", ";\n  color: ", ";\n"])), function (props) { return props.theme.largeFontSize; }, function (props) { return readableColor(props.theme.backgroundContent); });
var ProgressTextUnder = styled.div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  font-size: ", ";\n  visibility: hidden;\n"], ["\n  font-size: ", ";\n  visibility: hidden;\n"])), function (props) { return props.theme.largeFontSize; });
var ProgressInfo = styled.div(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  font-size: ", ";\n  color: ", ";\n"], ["\n  font-size: ", ";\n  color: ", ";\n"])), function (props) { return props.theme.mediumFontSize; }, function (props) { return readableColor(props.theme.backgroundContent); });
var ProgressBar = styled.div(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  z-index: 0;\n  top: 0px;\n  left: 0px;\n  position: absolute;\n  width: 0%;\n  height: 100%;\n  background: ", ";\n  transition: width ", " linear;\n"], ["\n  z-index: 0;\n  top: 0px;\n  left: 0px;\n  position: absolute;\n  width: 0%;\n  height: 100%;\n  background: ", ";\n  transition: width ", " linear;\n"])), function (props) { return props.theme.positiveColor; }, function (props) { return props.theme.coreTransitionTime; });
var OverwriteSuccess = styled(OverwriteStatus)(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  color: ", ";\n  background: ", ";\n"], ["\n  color: ", ";\n  background: ", ";\n"])), function (props) { return readableColor(props.theme.positiveColor); }, function (props) { return props.theme.positiveColor; });
var OverwriteError = styled(OverwriteStatus)(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  color: ", ";\n  background: ", ";\n"], ["\n  color: ", ";\n  background: ", ";\n"])), function (props) { return readableColor(props.theme.negativeColor); }, function (props) { return props.theme.negativeColor; });
var ResultMessage = styled.div(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n  font-size: ", ";\n  margin-left: ", ";\n"], ["\n  font-size: ", ";\n  margin-left: ", ";\n"])), function (props) { return props.theme.largeFontSize; }, function (props) { return props.theme.minimumButtonSize; });
var OverwriteBack = styled.button(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n  position: absolute;\n  left: 0px;\n  top: 0px;\n  width: ", ";\n  height: 100%;\n  text-align: center;\n"], ["\n  position: absolute;\n  left: 0px;\n  top: 0px;\n  width: ", ";\n  height: 100%;\n  text-align: center;\n"])), function (props) { return props.theme.minimumButtonSize; });
var Confirm = function (props) { return (React.createElement(OverwriteConfirm, { "data-id": "overwrite-confirm-button", variant: "contained", color: "secondary", onClick: props.archive, "data-help": "This will overwrite the item content. To restore a previous content, you can click on 'File' in the toolbar, and then click 'Restore Archived Items'." },
    React.createElement(MainText, null, "Overwrite content"),
    React.createElement(SubText, null, "WARNING: This will completely overwrite the current content and metadata."))); };
...
var Success = function (props) { return (React.createElement(OverwriteSuccess, null,
    React.createElement(OverwriteBack, { onClick: props.startOver },
...
export var MetacardOverwrite = function (_a) {
    var lazyResult = _a.lazyResult;
    var dialogState = useDialogState();
    ...
    return (React.createElement(Root, null,
        ...
        React.createElement(Dialog, __assign({}, dialogState.MuiDialogProps),
            React.createElement(DialogTitle, null, "Are you sure you want to overwrite the content?"),
        ...
        React.createElement(Component, __assign({}, state, { archive: function () {
