...
export declare const BaseCanWritePermission: CanWritePermissionType;
export declare const OverridableCanWritePermission: Overridable<CanWritePermissionType>;
export declare const useCanWritePermission: () => CanWritePermissionType;
