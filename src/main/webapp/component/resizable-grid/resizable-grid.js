...
export var useResizableGrid = function (_a) {
    var startingLength = _a.startingLength, collapsedLength = _a.collapsedLength, autoCollapseLength = _a.autoCollapseLength;
    var _b = __read(React.useState(false), 2), closed = _b[0], setClosed = _b[1];
    var _c = __read(React.useState(startingLength), 2), length = _c[0], setLength = _c[1];
    var _d = __read(React.useState(startingLength), 2), lastLength = _d[0], setLastLength = _d[1];
    var _e = __read(React.useState(false), 2), dragging = _e[0], setDragging = _e[1];
...
export var SplitPane = function (_a) {
    var secondStyle = _a.secondStyle, variant = _a.variant, children = _a.children, _b = _a.collapsedLength, collapsedLength = _b === void 0 ? DEFAULT_COLLAPSED_LENGTH : _b, _c = _a.autoCollapseLength, autoCollapseLength = _c === void 0 ? DEFAULT_AUTO_COLLAPSE_LENGTH : _c, _d = _a.startingLength, startingLength = _d === void 0 ? DEFAULT_STARTING_LENGTH : _d;
    var _e = useResizableGrid({ collapsedLength: collapsedLength, startingLength: startingLength, autoCollapseLength: autoCollapseLength }), length = _e.length, closed = _e.closed, setClosed = _e.setClosed, setLength = _e.setLength, lastLength = _e.lastLength, setLastLength = _e.setLastLength, dragging = _e.dragging, setDragging = _e.setDragging;
