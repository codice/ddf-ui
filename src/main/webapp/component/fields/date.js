...
export var DateField = function (_a) {
    var value = _a.value, onChange = _a.onChange, BPDateProps = _a.BPDateProps;
    ...
    React.useEffect(function () {
        validateDate({ onChange: onChange, value: value }, valueRef);
    }, []);
    return (React.createElement(React.Fragment, null,
        React.createElement(DateInput, __assign({ className: MuiOutlinedInputBorderClasses, minDate: DefaultMinDate, maxDate: DefaultMaxDate, closeOnSelection: false, fill: true, formatDate: DateHelpers.Blueprint.commonProps.formatDate, onChange: DateHelpers.Blueprint.DateProps.generateOnChange(function (value) {
