...
var getDefaultPropertiesToApplyTo = function () {
    return (properties.basicSearchTemporalSelectionDefault || []).map(function (property) {
        return {
        ...
        React.createElement("div", null,
            ...
            value ? (React.createElement(Grid, { container: true, alignItems: "stretch", direction: "column", wrap: "nowrap", className: "pt-2" },
                React.createElement(Grid, { item: true, className: "w-full pb-2" },
                    React.createElement(Autocomplete, { fullWidth: true, multiple: true, options: getPossibleProperties(), disableCloseOnSelect: true, getOptionLabel: function (option) { return option.label; }, getOptionSelected: function (option, value) {
