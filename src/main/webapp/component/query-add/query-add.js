...
export var QueryAddReact = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("form", { target: "autocomplete", action: "/search/catalog/blank.html", className: "w-full" }, (function () {
            if (form.id === 'basic') {
                return (React.createElement(QueryBasic, { model: model, key: model.id, errorListener: errorListener }));
            }
            else {
                return (React.createElement(QueryAdvanced, { model: model, key: model.id, errorListener: errorListener }));
            }
        })())));
};
