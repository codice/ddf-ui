...
var Open = function () {
    ...
    return (React.createElement("div", { className: "w-full h-full p-2" },
        React.createElement(Button, { onClick: openMenuState.handleClick, className: "text-2xl pb-2", variant: "contained", color: "primary", innerRef: openMenuState.anchorRef }, "Create"),
        React.createElement(Popover, { open: titleMenuState.open, anchorEl: titleMenuState.anchorRef.current, onClose: titleMenuState.handleClose, anchorOrigin: { vertical: 'bottom', horizontal: 'left' }, getContentAnchorEl: null },
        ...
        React.createElement(Popover, { open: fromExistingMenuState.open, anchorEl: fromExistingMenuState.anchorRef.current, onClose: fromExistingMenuState.handleClose, anchorOrigin: { vertical: 'bottom', horizontal: 'left' }, getContentAnchorEl: null },
        ...
        React.createElement(Popover, { open: openMenuState.open, onClose: openMenuState.handleClose, anchorEl: openMenuState.anchorRef.current, anchorOrigin: { vertical: 'bottom', horizontal: 'left' } },
            React.createElement(MenuItem, { innerRef: titleMenuState.anchorRef, onClick: function () {
                    titleMenuState.handleClick();
                } }, "Search"),
            React.createElement(MenuItem, { innerRef: fromExistingMenuState.anchorRef, onClick: function () {
