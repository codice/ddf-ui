...
export var OpenSearch = function (_a) {
    ...
    return (React.createElement(Autocomplete, __assign({ className: "w-64", getOptionSelected: function (option) { return option.plain.id === option.plain.id; }, getOptionLabel: function (option) { return option.plain.metacard.properties.title; }, options: options, innerRef: inputRef, open: open && positioningDone, onOpen: function () {
            setOpen(true);
        }, onClose: function () {
            setOpen(false);
            ...
            if (inputRef.current) {
                ...
                if (highlightedElementString) {
                    setCurrentHighlight(document.querySelector("#".concat(highlightedElementString)).querySelector('div'));
                }
                else {
        ...
        }, noOptionsText: "Nothing found.", renderOption: function (option) {
            return (React.createElement(Link, { className: "w-full p-0 font-normal no-underline hover:font-normal hover:no-underline", to: constructLink(option) },
            ...
            className: 'children-p-0 MuiAutocomplete-listbox'
...
var OptionsButton = function () {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Button, { fullWidth: true, innerRef: menuState.anchorRef, onClick: menuState.handleClick },
        ...
        React.createElement(Menu, { anchorEl: menuState.anchorRef.current, getContentAnchorEl: null, open: menuState.open, onClose: menuState.handleClose, keepMounted: true, disableEnforceFocus: true, disableAutoFocus: true, anchorOrigin: { vertical: 'bottom', horizontal: 'left' } },
            ...
            React.createElement(MenuItem, { innerRef: menuStateNewFromExisting.anchorRef, onClick: function () {
                    menuState.handleClose();
                    menuStateNewFromExisting.handleClick();
                } }, "New from existing"),
            React.createElement(MenuItem, { innerRef: menuStateOpenSearch.anchorRef, onClick: function () {
                    menuState.handleClose();
...
var SaveIndicator = function () {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(Button, { className: "shrink-0", onClick: function (e) {
                e.stopPropagation();
    ...
    return (React.createElement("div", { className: "min-h-16 ".concat(closed ? 'h-full shrink overflow-hidden' : '') },
        React.createElement("div", { className: "h-full w-full relative p-2 ".concat(closed
            ...
            searchPageMode === 'adhoc' ? (React.createElement(React.Fragment, null,
                ...
                React.createElement(Button, { component: "div", className: "children-block children-h-full text-left text-2xl shrink truncate ".concat(closed ? 'h-full' : ''), onClick: adhocMenuState.handleClick, size: "small", innerRef: adhocMenuState.anchorRef },
            ...
            data === true ? (React.createElement(React.Fragment, null,
                React.createElement(Skeleton, { variant: "rect", className: "w-full h-full" }))) : null,
            typeof data !== 'boolean' ? (React.createElement(React.Fragment, null,
                ...
                React.createElement(Button, { fullWidth: true, className: "children-block children-h-full text-left text-2xl shrink overflow-hidden ".concat(closed ? 'h-full' : ''), onClick: savedMenuState.handleClick, size: "small", innerRef: savedMenuState.anchorRef },
...
var LeftMiddle = function () {
    ...
    return (React.createElement("div", { className: "overflow-hidden w-full ".concat(closed ? 'shrink hidden' : 'h-full') }, data === true ? (React.createElement(Skeleton, { variant: "rect", className: "w-full h-full p-10" })) : (React.createElement("div", { className: "w-full h-full overflow-auto pb-64 ".concat(closed ? 'hidden' : '') },
