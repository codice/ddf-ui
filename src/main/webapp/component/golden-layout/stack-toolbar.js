        ...
        React.createElement("div", { className: "flex flex-row flex-nowrap items-center" },
            React.createElement(React.Fragment, null,
                isMaximized || isMinimized || !canBeMinimized ? (React.createElement(React.Fragment, null)) : (React.createElement("div", null,
                    React.createElement(CloseOnClickTooltip, { title: React.createElement(Paper, { elevation: Elevations.overlays, className: "p-2" }, "Minimize stack of visuals to bottom of layout") },
                ...
                isMaximized ? (React.createElement("div", null,
                    React.createElement(CloseOnClickTooltip, { title: React.createElement(Paper, { elevation: Elevations.overlays, className: "p-2" }, "Restore stack of visuals to original size") },
                        React.createElement(Button, { "data-id": "unmaximise-layout-button", onClick: function () {
                                stack.toggleMaximise();
                            } },
                            React.createElement(FullscreenExitIcon, null))))) : (React.createElement("div", null,
                    React.createElement(CloseOnClickTooltip, { title: React.createElement(Paper, { elevation: Elevations.overlays, className: "p-2" }, "Maximize stack of visuals") },
                ...
                stack.layoutManager.isSubWindow ? null : (React.createElement("div", null,
                    React.createElement(CloseOnClickTooltip, { title: React.createElement(Paper, { elevation: Elevations.overlays, className: "p-2" }, "Open stack of visuals in new window") },
                        React.createElement(Button, { "data-id": "popout-layout-button", onClick: function () {
                                stack.popout();
                            } },
                            React.createElement(PopoutIcon, { fontSize: "small" }))))),
                React.createElement("div", null, stack.header._isClosable() ? (React.createElement(CloseOnClickTooltip, { title: React.createElement(Paper, { elevation: Elevations.overlays, className: "p-2" }, "Close stack of visuals") },
