...
export var CellComponent = function (props) {
    var style = props.style, className = props.className, otherProps = __rest(props, ["style", "className"]);
    return (React.createElement("div", __assign({}, otherProps, { className: "inline-block ".concat(className, " p-2 overflow-auto whitespace-normal break-all "), style: __assign({ width: '200px', maxHeight: '200px' }, style) })));
};
...
export var Header = function (_a) {
    var lazyResults = _a.lazyResults, setHeaderColWidth = _a.setHeaderColWidth, headerColWidth = _a.headerColWidth;
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { "data-id": "table-container", className: "bg-inherit whitespace-nowrap flex items-strech flex-nowrap", style: {
                ...
                display: 'grid',
                gridTemplateColumns: "repeat(".concat(shownAttributes.length + 2, ", 1fr)")
            } },
