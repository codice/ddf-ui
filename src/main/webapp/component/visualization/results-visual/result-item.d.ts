...
export declare const ResultItem: ({ lazyResult, measure, selectionInterface, }: ResultItemFullProps) => JSX.Element;
declare const _default: ({ lazyResult, measure, selectionInterface, }: ResultItemFullProps) => JSX.Element;
