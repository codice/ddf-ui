...
export declare const ResultItem: ({ lazyResult, measure }: ResultItemFullProps) => JSX.Element;
declare const _default: ({ lazyResult, measure }: ResultItemFullProps) => JSX.Element;
