...
var Geometries = function (props) {
    var map = props.map, selectionInterface = props.selectionInterface, isClustering = props.isClustering, zoomToHome = props.zoomToHome;
    ...
    var ZoomToSelectionMemo = React.useMemo(function () {
        return (React.createElement(ZoomToSelection, { map: map, lazyResults: lazyResults, zoomToHome: zoomToHome }));
    }, [lazyResults]);
