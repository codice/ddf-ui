...
export default function (insertionElement: any, _selectionInterface: any, _notificationEl: any, _componentElement: any, mapModel: any, mapLayers: any): {
    ...
    addRulerPoint(coordinates: any, markerLabel: any): VectorLayer<VectorSource<Feature<Point>>, Feature<Point>>;
    removeRulerPoint(pointLayer: any): void;
    rulerLine: null | VectorLayer<VectorSource<Feature<LineString>>, Feature<LineString>>;
    addRulerLine(point: any): VectorLayer<VectorSource<Feature<LineString>>, Feature<LineString>>;
    ...
    addLabel(point: any, options: any): VectorLayer<VectorSource<Feature<Point>>, Feature<Point>>;
