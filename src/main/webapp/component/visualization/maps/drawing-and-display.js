...
export var useDrawingAndDisplayModels = function (_a) {
    ...
    useListenTo(wreqr.vent, 'search:linedisplay search:polydisplay search:bboxdisplay search:circledisplay search:keyworddisplay', function (model) {
        setModels(function (currentModels) {
            ...
            if (Array.isArray(model)) {
                newModels = __spreadArray([], __read(currentModels), false).concat(model.filter(function (newModel) { return !currentModels.includes(newModel); }));
            }
    ...
    var updateFilterModels = function () {
        var e_1, _a;
        try {
    ...
    useListenTo(wreqr.vent, 'search:line-end search:poly-end search:bbox-end search:circle-end search:drawcancel search:drawend', function (model) {
        ...
        model.forEach(function (submodel) {
            ...
            if (models.includes(submodel)) {
                setModels(models.filter(function (displayModel) { return displayModel !== submodel; }));
            }
        });
    });
    React.useEffect(function () {
