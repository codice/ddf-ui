...
export var useDrawingAndDisplayModels = function (_a) {
    ...
    useListenTo(wreqr.vent, 'search:drawline-end search:drawpoly-end search:drawbbox-end search:drawcircle-end search:drawcancel', function (model) {
        if (drawingModels.includes(model)) {
            setDrawingModels(drawingModels.filter(function (drawingModel) { return drawingModel !== model; }));
        }
    });
    useListenTo(wreqr.vent, 'search:drawend', function (drawendModels) {
        setDrawingModels(drawingModels.filter(function (drawingModel) {
            return !drawendModels.includes(drawingModel);
        }));
        setModels(models.filter(function (drawingModel) {
            return !drawendModels.includes(drawingModel);
        }));
    });
    React.useEffect(function () {
