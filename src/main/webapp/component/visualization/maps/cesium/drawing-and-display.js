...
export var CesiumDrawings = function (_a) {
    ...
    var pickLocation = function (attributes) {
        var mode = attributes === null || attributes === void 0 ? void 0 : attributes.mode;
        switch (mode) {
            case 'bbox':
    ...
    var drawModelAttributes = drawingModel === null || drawingModel === void 0 ? void 0 : drawingModel.attributes;
    var isNotBeingEdited = function (model) {
        return !_.isEqual(pickLocation(model.attributes), pickLocation(drawModelAttributes));
    };
    /*
