...
declare const OverflowTip: ({ children, tooltipProps, refOfThingToMeasure: refOfThingToMeasurePassedIn, className, }: OverflowTipType) => import("react/jsx-runtime").JSX.Element;
