...
var Line = function (props) {
    ...
    , { 
        // @ts-expect-error ts-migrate(2769) FIXME: No overload matches this call.
        list: usng.line.list, defaultItem: "", onChange: setState(function (draft, value) { return (draft.usng.line.list = value); }) }, grids));
};
var Polygon = function (props) {
    ...
    , { 
        // @ts-expect-error ts-migrate(2769) FIXME: No overload matches this call.
        list: usng.polygon.list, defaultItem: "", onChange: setState(function (draft, value) { return (draft.usng.polygon.list = value); }) }, grids));
};
