...
var Line = function (props) {
    ...
    , { 
        // @ts-expect-error ts-migrate(2769) FIXME: No overload matches this call.
        list: dd.line.list, defaultItem: ddPoint, onChange: setState(function (draft, value) { return (draft.dd.line.list = value); }) }, points));
};
var Polygon = function (props) {
    ...
    , { 
        // @ts-expect-error ts-migrate(2769) FIXME: No overload matches this call.
        list: dd.polygon.list, defaultItem: ddPoint, onChange: setState(function (draft, value) { return (draft.dd.polygon.list = value); }) }, points));
};
