...
var Line = function (props) {
    ...
    , { 
        // @ts-expect-error ts-migrate(2769) FIXME: No overload matches this call.
        list: dms.line.list, defaultItem: dmsPoint, onChange: setState(function (draft, value) { return (draft.dms.line.list = value); }) }, points));
};
var Polygon = function (props) {
    ...
    , { 
        // @ts-expect-error ts-migrate(2769) FIXME: No overload matches this call.
        list: dms.polygon.list, defaultItem: dmsPoint, onChange: setState(function (draft, value) { return (draft.dms.polygon.list = value); }) }, points));
};
