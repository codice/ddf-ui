...
export declare const QueryAdvanced: ({ model, errorListener, Extensions }: Props) => JSX.Element;
declare const _default: ({ model, errorListener, Extensions }: Props) => JSX.Element;
