...
export declare class FilterClass extends SpreadOperatorProtectedClass {
    ...
    constructor({ type, property, value, negated, id, context, }?: {
...
export declare class ResourceSizeFilterClass extends FilterClass {
    value: number;
    context: FilterContext & {
        units: string;
    };
    constructor({ value, context, ...otherProps }: Omit<FilterClass, '_DO_NOT_USE_SPREAD_OPERATOR' | 'value' | 'context'> & {
        value: number;
        context: FilterContext & {
            units: string;
        };
...
export declare class ResourceSizeRangeFilterClass extends FilterClass {
    value: {
        start: number;
        end: number;
    };
...
export declare const isResourceSizeFilterClass: (filter: FilterBuilderClass | FilterClass | CQLStandardFilterBuilderClass | Partial<FilterBuilderClass> | Partial<FilterClass> | Partial<CQLStandardFilterBuilderClass>) => filter is ResourceSizeFilterClass;
export declare const isResourceSizeRangeFilterClass: (filter: FilterBuilderClass | FilterClass | CQLStandardFilterBuilderClass | Partial<FilterBuilderClass> | Partial<FilterClass> | Partial<CQLStandardFilterBuilderClass>) => filter is ResourceSizeRangeFilterClass;
export declare const sizeUnits: string[];
export declare const convertResourceSizeFilterClassValueToBytes: (filter: ResourceSizeFilterClass) => number;
export declare const convertResourceSizeRangeFilterClassValueToBytes: (filter: ResourceSizeRangeFilterClass) => {
    start: number;
    end: number;
};
export declare function convertBytesToHumanReadable(bytes: number): string;
export {};
