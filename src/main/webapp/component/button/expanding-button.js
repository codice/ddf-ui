...
var ExpandingButton = function (_a) {
    ...
    return (React.createElement(Tooltip, { title: disableTooltip ? ('') : (React.createElement(Paper, { elevation: Elevations.overlays },
        ...
        React.createElement(Button, __assign({ "data-id": dataId, fullWidth: true, className: "".concat(className, " children-block children-h-full transition-all duration-200 ease-in-out whitespace-nowrap max-w-full overflow-hidden relative outline-none ").concat(expanded ? '' : 'p-0') }, otherButtonProps),
