...
declare const ExpandingButton: ({ expanded, Icon, expandedLabel, unexpandedLabel, dataId, orientation, ...buttonProps }: ExpandingButtonProps) => import("react/jsx-runtime").JSX.Element;
