...
export var Common = {
    ...
    generateUUID: function () {
        ...
        if (!properties.useHyphensInUuid)
            return uuid;
        var chunks = uuid.match(/.{1,4}/g);
        var prefix = chunks === null || chunks === void 0 ? void 0 : chunks.slice(0, 2).join('');
        var middle = chunks === null || chunks === void 0 ? void 0 : chunks.slice(2, 5).join('-');
        var suffix = chunks === null || chunks === void 0 ? void 0 : chunks.slice(5, chunks.length).join('');
        return "".concat(prefix, "-").concat(middle, "-").concat(suffix);
    },
