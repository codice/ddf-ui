...
declare const _default: {
    ...
    arrayFromLinestringWkt: (wkt: string) => Array<[number, number]>;
    arrayFromMultilinestringWkt: (wkt: string) => Array<Array<[number, number]>>;
    arrayFromPointWkt: (wkt: string) => Array<[number, number]>;
};
