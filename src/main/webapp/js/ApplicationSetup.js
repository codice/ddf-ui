...
$(window.document).ready(function () {
    window.document.title =
        properties.customBranding + ' ' + properties.product;
    // @ts-expect-error ts-migrate(2531) FIXME: Object is possibly 'null'.
    window.document.querySelector('.welcome-branding').textContent = properties.customBranding;
    // @ts-expect-error ts-migrate(2531) FIXME: Object is possibly 'null'.
    window.document.querySelector('.welcome-branding-name').textContent = properties.product;
    // @ts-expect-error ts-migrate(2531) FIXME: Object is possibly 'null'.
