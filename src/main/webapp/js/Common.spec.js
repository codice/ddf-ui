...
describe('Common', function () {
    ...
    describe('generateUUID', function () {
        it('has dashes', function () {
            properties.useHyphensInUuid = true;
            var uuid = Common.generateUUID();
            expect(uuid).to.satisfy(function (value) { return value.indexOf('-') >= 0; });
            properties.useHyphensInUuid = false;
        });
        it('does not have dashes', function () {
            var uuid = Common.generateUUID();
            expect(uuid).to.satisfy(function (value) { return value.indexOf('-') === -1; });
        });
    });
    describe('getImageSrc', function () {
        ...
        it('returns url unchanged', function () {
