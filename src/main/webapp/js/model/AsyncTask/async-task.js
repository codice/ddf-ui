...
export var convertToBackendCompatibleForm = function (_a) {
    ...
    var duplicatedProperties = JSON.parse(JSON.stringify(properties));
            ...
            callback: function () {
                ...
                if (!deletedId) {
                    ...
                    fetch("./internal/history/revert/".concat(deletedId, "/").concat(deletedVersion, "/").concat(sourceId)).then(function () {
                        _this._notifySubscribers('update');
                    });
                    unsubscibeCallback();
                }
            }
...
var CreateTask = /** @class */ (function (_super) {
    ...
    function CreateTask(_a) {
        ...
        _this.data = data;
        _this.data.id = _this.data.id || Common.generateUUID();
        setTimeout(function () {
            _this.attemptSave();
        }, 1000);
        return _this;
...
var CreateSearchTask = /** @class */ (function (_super) {
    ...
    function CreateSearchTask(_a) {
        ...
        var _this = _super.call(this) || this;
        _this.data = data;
        _this.data.id = Common.generateUUID();
        setTimeout(function () {
            _this.attemptSave();
        }, 1000);
        return _this;
