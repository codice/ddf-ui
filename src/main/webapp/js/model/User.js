...
User.updateMapLayers = function (layers) {
    var providers = properties.imageryProviders;
...
User.MapLayers = Backbone.Collection.extend({
    model: User.MapLayer,
    defaults: function () {
        return _.map(_.values(properties.imageryProviders), function (layerConfig) { return new User.MapLayer(layerConfig, { parse: true }); });
    },
