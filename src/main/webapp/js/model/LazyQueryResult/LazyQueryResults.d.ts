...
type SubscribableType = 'status' | 'filteredResults' | 'selectedResults' | 'results.backboneSync';
...
export declare class LazyQueryResults {
     ...
     */
    _fakeResort(): void;
    constructor({ results, sorts, sources, transformSorts, }?: ConstructorProps);
    init(): void;
    _resetSelectedResults(): void;
    reset({ results, sorts, sources, transformSorts, }?: ConstructorProps): void;
    destroy(): void;
    isEmpty(): boolean;
    add({ results, highlights, }?: {
        results?: ResultType[];
