...
var MetacardDefinitions = /** @class */ (function (_super) {
    ...
    function MetacardDefinitions(startupData) {
        ...
        _this.isHiddenType = function (id) {
            if (!_this.attributeMap) {
                return false;
            }
            return (_this.attributeMap[id] === undefined ||
                _this.attributeMap[id].type === 'XML' ||
                _this.attributeMap[id].type === 'BINARY' ||
                _this.attributeMap[id].type === 'OBJECT');
        };
        /**
         ...
         */
        _this.isHiddenTypeExceptThumbnail = function (attributeName) {
            if (attributeName === 'thumbnail') {
                return false;
            }
            else {
                return _this.isHiddenType(attributeName);
            }
        };
