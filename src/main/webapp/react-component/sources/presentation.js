...
export default hot(module)(function (_a) {
    var sources = _a.sources, amountDown = _a.amountDown, refreshSources = _a.refreshSources;
    return (React.createElement(Root, null,
        React.createElement(SourcesCenter, null,
            React.createElement(SourcesSummary, { amountDown: amountDown }),
            sources.map(function (source) {
                return (React.createElement(SourceItem, { key: source.id, sourceActions: source.sourceActions, refreshSources: refreshSources, id: source.id, available: source.available }));
            }))));
});
