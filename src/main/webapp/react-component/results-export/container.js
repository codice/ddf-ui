...
var ResultsExport = /** @class */ (function (_super) {
    ...
    ResultsExport.prototype.onDownloadClick = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var uriEncodedTransformerId, response, count, cql, srcs, searches, result, filename, contentType, data;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, exportResult(result.source, result.id, uriEncodedTransformerId, result.attributes.toString())];
                    case 5:
                        response = _c.sent();
                        _c.label = 6;
                    case 6:
