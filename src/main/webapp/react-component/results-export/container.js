...
var ResultsExport = /** @class */ (function (_super) {
    ...
    function ResultsExport(props) {
        ...
        _this.fetchExportOptions = function () {
            fetch("./internal/transformers/".concat(_this.getTransformerType()))
                .then(function (response) { return response.json(); })
                .then(function (exportFormats) {
                return exportFormats.sort(function (format1, format2) {
    ...
    ResultsExport.prototype.onDownloadClick = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var uriEncodedTransformerId, response, count, cql, srcs, searches, columnOrder, result, filename, contentType, data;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 6];
                    case 2:
                        if (!(this.props.results.length > 1)) return [3 /*break*/, 4];
                        return [4 /*yield*/, exportResultSet(uriEncodedTransformerId, {
                                searches: searches,
                                count: count,
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, exportResult(result.source, result.id, uriEncodedTransformerId, columnOrder.toString())];
                    case 5:
                        response = _d.sent();
                        _d.label = 6;
                    case 6:
