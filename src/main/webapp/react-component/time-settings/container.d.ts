...
declare const _default: {
    new (props: Readonly<import("../../typescript/subtract").default<WithBackboneProps, WithBackboneProps>>): {
        backbone: any;
        ...
        readonly props: Readonly<import("../../typescript/subtract").default<WithBackboneProps, WithBackboneProps>> & Readonly<{
