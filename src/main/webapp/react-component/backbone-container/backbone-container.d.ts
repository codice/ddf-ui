...
declare const withListenTo: <P extends WithBackboneProps>(Component: React.ComponentType<P>) => {
    new (props: Readonly<Subtract<P, WithBackboneProps>>): {
        backbone: any;
        ...
        readonly props: Readonly<Subtract<P, WithBackboneProps>> & Readonly<{
