...
export default hot(module)(/** @class */ (function (_super) {
    ...
    function TableExport(props) {
        ...
        _this.transformUrl = './internal/cql/transform/';
    ...
    TableExport.prototype.render = function () {
        ...
        var _b = this.props, exportFormats = _b.exportFormats, selectionInterface = _b.selectionInterface, onDownloadClick = _b.onDownloadClick, getWarning = _b.getWarning, filteredAttributes = _b.filteredAttributes;
