...
var UserComponent = function () {
    ...
    return (React.createElement("div", { className: "w-full h-full flex flex-col" },
        ...
        React.createElement("div", { className: "text-right p-2 shrink-0" }, isGuest ? (React.createElement("div", null)) : (React.createElement(Button, { "data-id": "profile-signout-button", color: "primary", variant: "contained", onClick: signOut }, "Sign Out")))));
};
