...
function updateTheme(userTheme) {
    ...
    return __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({ spacingMode: 'comfortable' }, relevantColorTheme), userTheme), sizingTheme), borderRadius), screenSizes), zIndexes), transitions), fontSizes), spacing(parseFloat(sizingTheme.minimumSpacing))), dividers(parseFloat(sizingTheme.minimumSpacing))), opacity);
}
