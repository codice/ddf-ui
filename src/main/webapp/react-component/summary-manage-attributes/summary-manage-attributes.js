    ...
    return (React.createElement(Button, { "data-id": "manage-attributes-button", onClick: function () {
            dialogContext.setProps({
                ...
                children: (React.createElement("div", { style: {
                    ...
                    React.createElement(TransferList, { startingLeft: user
                            .get('user')
                            .get('preferences')
                            .get('inspector-summaryShown'), startingRight: TypedUserInstance.getResultsAttributesPossibleTable(), startingHideEmpty: user
                            .get('user')
                            .get('preferences')
