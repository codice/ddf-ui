...
var LineLatLon = function (props) {
    var label = props.label, geometryKey = props.geometryKey, setState = props.setState, setBufferState = props.setBufferState, unitKey = props.unitKey, widthKey = props.widthKey, mode = props.mode, polyType = props.polyType;
    ...
    useEffect(function () {
        ...
        setCurrentValue(typeof props[geometryKey] === 'string'
            ? props[geometryKey]
        ...
        React.createElement("div", { className: "input-location flex flex-col flex-nowrap space-y-2" },
            ...
            , { 
                ...
                label: label, value: currentValue, onChange: function (value) {
                    ...
                    return setBaseLineError(validateGeo(mode || polyType, currentValue));
                } }),
...
var LineDms = function (props) {
    var geometryKey = props.geometryKey, dmsPointArray = props.dmsPointArray, setState = props.setState, unitKey = props.unitKey, setBufferState = props.setBufferState, widthKey = props.widthKey;
...
var LineMgrs = function (props) {
    var geometryKey = props.geometryKey, usngPointArray = props.usngPointArray, setState = props.setState, unitKey = props.unitKey, setBufferState = props.setBufferState, widthKey = props.widthKey;
    var _a = __read(useState(initialErrorState), 2), baseLineError = _a[0], setBaseLineError = _a[1];
    var _b = __read(useState(initialErrorState), 2), bufferError = _b[0], setBufferError = _b[1];
    useEffect(function () {
        if (props.drawing) {
...
var LineUtmUps = function (props) {
    var geometryKey = props.geometryKey, utmUpsPointArray = props.utmUpsPointArray, setState = props.setState, unitKey = props.unitKey, setBufferState = props.setBufferState, widthKey = props.widthKey;
    var _a = __read(useState(initialErrorState), 2), baseLineError = _a[0], setBaseLineError = _a[1];
    var _b = __read(useState(initialErrorState), 2), bufferError = _b[0], setBufferError = _b[1];
    useEffect(function () {
        if (props.drawing) {
