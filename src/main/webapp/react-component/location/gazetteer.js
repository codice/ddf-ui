...
var Gazetteer = function (props) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, window.__global__fetch("https://nominatim.openstreetmap.org/reverse?format=json&osm_type=".concat(type, "&osm_id=").concat(id, "&polygon_geojson=1"))];
                case 1:
                    res = _b.sent();
                    return [4 /*yield*/, res.json()];
                case 2:
    ...
    return (React.createElement(React.Fragment, null, onlineGazetteer ? (React.createElement(Keyword, { value: props.value, setState: props.setState, suggester: suggester, geofeature: geofeature, placeholder: props.placeholder, loadingMessage: props.loadingMessage, variant: props.variant })) : (React.createElement(Keyword, { value: props.value, setState: props.setState, suggester: suggesterWithLiteralSupport, geofeature: geofeatureWithLiteralSupport, placeholder: props.placeholder, loadingMessage: props.loadingMessage, variant: props.variant }))));
};
