        ...
        React.createElement("div", null,
            React.createElement(Grid, { container: true, direction: "row", wrap: "nowrap", alignItems: "center" },
                React.createElement(Grid, { item: true, className: "w-full" },
                    React.createElement(Autocomplete, { "data-id": "sort-type-autocomplete", size: "small", fullWidth: true, options: attributeOptions, getOptionLabel: function (option) { return option.label; }, getOptionSelected: function (option, value) {
            ...
            isDirectionalSort(sortItem.attribute.value) ? (React.createElement(Grid, { container: true, alignItems: "stretch", direction: "row", wrap: "nowrap", className: "pt-2" },
                ...
                React.createElement(Grid, { item: true, className: "w-full pl-2" },
                    React.createElement(Autocomplete, { "data-id": "sort-order-autocomplete", size: "small", fullWidth: true, options: directionOptions, getOptionLabel: function (option) { return option.label; }, getOptionSelected: function (option, value) {
                            return option.value === value.value;
                        }, onChange: function (_e, newValue) {
                            var newProperty = newValue.value;
