...
export var getSortAttributeOptions = function (currentSelections) {
    ...
    var options = attributes
        .filter(function (type) { return !StartupDataStore.Configuration.isHiddenAttribute(type.id); })
        .filter(function (type) {
        return !StartupDataStore.MetacardDefinitions.isHiddenTypeExceptThumbnail(type.id);
    })
