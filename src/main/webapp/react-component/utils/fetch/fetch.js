        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2: return [2 /*return*/, _c.apply(_b, [(_d.json = _e.sent(),
                            _d)])];
                case 3: return [2 /*return*/, fetch(cacheBust(url), __assign(__assign({ credentials: 'same-origin', cache: 'no-cache' }, opts), { headers: __assign({ 'X-Requested-With': 'XMLHttpRequest' }, headers) }))];
            }
        });
    });
}
