...
var FilterInput = function (_a) {
    ...
    switch (type) {
        ...
        case 'LOCATION':
            return React.createElement(LocationInput, { value: value, onChange: onChange });
        case 'FLOAT':
    ...
    var textValue = value;
    var enumForAttr = MetacardDefinitions.getEnum({ attr: filter.property });
    var deprecatedEnumForAttr = MetacardDefinitions.getDeprecatedEnum({
