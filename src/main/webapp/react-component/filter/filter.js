...
var Filter = function (_a) {
    ...
    return (React.createElement(Grid, { container: true, direction: "column", alignItems: "center", className: "w-full" },
        React.createElement(Grid, { item: true, className: "w-full pb-2" },
            React.createElement(Autocomplete, { "data-id": "filter-type-autocomplete", fullWidth: true, size: "small", options: attributeList, groupBy: groupBy, getOptionLabel: function (option) { return option.label; }, getOptionSelected: function (option, value) { return option.value === value.value; }, onChange: function (_e, newValue) {
                    /**
        ...
        React.createElement(Grid, { "data-id": "filter-input", item: true, className: "w-full" },
            React.createElement(FilterInput, { filter: filter, setFilter: setFilter }))));
};
