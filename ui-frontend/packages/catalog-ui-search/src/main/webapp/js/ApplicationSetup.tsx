...
Backbone.AssociatedModel.prototype.set = function (key: any, value: any, options: any) {
...
$(window.document).ready(() => {
    window.document.title = (properties as any).customBranding + ' ' + (properties as any).product;
