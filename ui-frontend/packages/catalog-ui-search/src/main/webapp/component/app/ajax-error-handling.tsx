...
let getErrorResponse = function (_event: any, jqxhr: any, settings: any, throwError: any) {
...
export const AjaxErrorHandling = () => {
    ...
    React.useEffect(() => {
        $(window.document).ajaxError((event: any, jqxhr: any, settings: any, throwError: any) => {
            ...
            if ((properties as any).disableUnknownErrorBox &&
