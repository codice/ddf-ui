...
import { drawPolygon, translateFromOpenlayersCoordinates, } from './polygon-display';
    ...
    React.useEffect(() => {
        if (map && model) {
            ...
            primitive.on('drawend', (sketchFeature: any) => {
                ...
                (wreqr as any).vent.trigger('search:drawpoly-end', model);
...
export const OpenlayersPolygonDrawing = ({ map, model, }: {
    map: any;
    model: any;
}) => {
