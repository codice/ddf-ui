...
const setModelFromGeometry = ({ model, geometry, }: {
    ...
    const northWest = ol.proj.transform([extent[0], extent[3]], (properties as any).projection, 'EPSG:4326');
    const southEast = ol.proj.transform([extent[2], extent[1]], (properties as any).projection, 'EPSG:4326');
    model.set({
...
export const OpenlayersBboxDrawing = ({ map, model, }: {
    map: any;
    model: any;
}) => {
