...
const mockStartupPayload: StartupPayloadType = {
  ...
  config: {
    ...
    customBackgroundAccentContent: '#ff0000',
    customNegativeColor: '#0000ff',
    attributeSuggestionList: [],
    isHistoricalSearchDisabled: false,
    summaryShow: ['name', 'age'],
    queryFeedbackEmailDestination: 'support@example.com',
    readOnly: [],
    version: '1.2.3',
    ...
    queryFeedbackEmailSubjectTemplate: 'Feedback - App Version {version}',
    customBackgroundModal: '#00ff00',
    isExperimental: false,
    queryFeedbackEmailBodyTemplate: 'Type your feedback here...',
    sourcePollInterval: 30000,
    customBackgroundContent: '#ffff00',
    requiredAttributes: ['name'],
    customWarningColor: '#ff6600',
    ...
    customBackgroundDropdown: '#880088',
    ...
    theme: 'dark',
    customPrimaryColor: '#ff3366',
    projection: 'EPSG:4326',
    defaultLayout: [],
    webSocketsEnabled: true,
    showRelevanceScores: true,
    menuIconSrc: 'menu-icon.png',
    customPositiveColor: '#00cc00',
    product: 'My Awesome App',
    customFavoriteColor: '#ff9900',
    typeNameMapping: {
      person: 'PersonType',
      place: 'PlaceType',
    },
    ...
    customBackgroundNavigation: '#000000',
    customBackgroundSlideout: '#ffffff',
  },
