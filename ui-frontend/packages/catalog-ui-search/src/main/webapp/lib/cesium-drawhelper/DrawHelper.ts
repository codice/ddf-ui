...
const DrawHelper = (function () {
    ...
    function _(this: any, this: any, this: any, this: any, this: any, cesiumWidget: any) {
    ...
    _.prototype.setListener = function (primitive: any, type: any, callback: any) {
    ...
    const ChangeablePrimitive = (function () {
         ...
         * @private
         */
        _.prototype.update = function (context: any, frameState: any, commandList: any) {
    ...
    _.prototype.createBillboardGroup = function (points: any, options: any, callbacks: any) {
        // @ts-expect-error ts-migrate(7009) FIXME: 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
    ...
    _.BillboardGroup.prototype.createBillboard = function (position: any, callbacks: any) {
        ...
        if (callbacks) {
            ...
            if (callbacks.dragHandlers) {
                ...
                setListener(billboard, 'leftDown', (position: any) => {
                    ...
                    handler.setInputAction((movement: any) => {
                        const cartesian = _self._scene.camera.pickEllipsoid(movement.endPosition, ellipsoid);
                        if (cartesian) {
                            onDrag(cartesian);
                        }
                        else {
    ...
    _.BillboardGroup.prototype.insertBillboard = function (index: any, position: any, callbacks: any) {
        this._orderedBillboards.splice(index, 0, this.createBillboard(position, callbacks));
    };
    _.BillboardGroup.prototype.addBillboard = function (position: any, callbacks: any) {
        this._orderedBillboards.push(this.createBillboard(position, callbacks));
    };
    _.BillboardGroup.prototype.addBillboards = function (positions: any, callbacks: any) {
        let index = 0;
        for (; index < positions.length; index++) {
            this.addBillboard(positions[index], callbacks);
        }
    };
    _.BillboardGroup.prototype.updateBillboardsPositions = function (positions: any) {
        let index = 0;
        for (; index < positions.length; index++) {
        ...
        mouseHandler.setInputAction((movement: any) => {
            ...
            if (position != null) {
                if (extent == null) {
                    ...
                    const cartesian = scene.camera.pickEllipsoid(position, ellipsoid);
                    if (cartesian) {
                        const value = getExtent(firstPoint, ellipsoid.cartesianToCartographic(cartesian));
                        updateExtent(value);
    ...
    _.prototype.enhancePrimitives = function () {
        ...
        Cesium.Billboard.prototype.setEditable = function () {
            ...
            setListener(billboard, 'leftDown', (position: any) => {
                ...
                handler.setInputAction((movement: any) => {
                    const cartesian = drawHelper._scene.camera.pickEllipsoid(movement.endPosition, ellipsoid);
                    if (cartesian) {
                        onDrag(cartesian);
                    }
                    else {
        ...
        // @ts-expect-error ts-migrate(2300) FIXME: Duplicate identifier 'this'.
        function setHighlighted(this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, highlighted: any) {
        ...
        // @ts-expect-error ts-migrate(2300) FIXME: Duplicate identifier 'this'.
        function setEditMode(this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, this: any, editMode: any) {
            // if no change
                    ...
                    const handleEditMarkerChanges = {
                        dragHandlers: {
                            ...
                            onDragEnd(index: any, position: any) {
                                ...
                                markers.insertBillboard((this as any).index, position, handleMarkerChanges);
                                editMarkers.getBillboard((this as any).index - 1).position = calculateHalfMarkerPosition((this as any).index - 1);
                                editMarkers.insertBillboard((this as any).index, calculateHalfMarkerPosition((this as any).index), handleEditMarkerChanges);
                                _self._createPrimitive = true;
                                onEdited();
                            },
                        },
                ...
                if (editMode) {
                    ...
                    if (this._markers == null) {
                        ...
                        const handleMarkerChanges = {
                            dragHandlers: {
                                onDrag(index: any, position: any) {
                                    const distance = Cesium.Cartesian3.distance(ellipse.getCenter(), position);
                                    if (index % 2 == 0) {
        ...
        _.CirclePrimitive.prototype.getCircleCartesianCoordinates = function (granularity: any) {
            const geometry = Cesium.CircleOutlineGeometry.createGeometry(new Cesium.CircleOutlineGeometry({
                ellipsoid,
                center: this.getCenter(),
                radius: this.getRadius(),
                granularity,
    ...
    _.DrawHelperWidget = (function () {
        ...
        function _(this: any, this: any, drawHelper: any, options: any) {
            ...
            const scene = drawHelper._scene;
            addIcon('marker', options.markerIcon, 'Click to start drawing a 2D marker', () => {
            ...
            addIcon('polyline', options.polylineIcon, 'Click to start drawing a 2D polyline', () => {
            ...
            addIcon('polygon', options.polygonIcon, 'Click to start drawing a 2D polygon', () => {
            ...
            addIcon('extent', options.extentIcon, 'Click to start drawing an Extent', () => {
            ...
            addIcon('circle', options.circleIcon, 'Click to start drawing a Circle', () => {
