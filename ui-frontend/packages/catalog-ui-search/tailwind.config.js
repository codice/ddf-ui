module.exports = {
  ...
  variants: {
    ...
    transform: ['responsive', 'group-hover', 'group-focus'],
    ...
    transitionProperty: ['responsive', 'group-hover', 'group-focus'],
    transitionTimingFunction: ['responsive', 'group-hover', 'group-focus'],
    transitionDuration: ['responsive', 'group-hover', 'group-focus'],
    transitionDelay: ['responsive', 'group-hover', 'group-focus'],
